...
public class EaseChatPrimaryMenu extends EaseChatPrimaryMenuBase implements OnClickListener {
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        mSpeakTv = findViewById(R.id.speak_tv);
...
//                    edittext_layout.setBackgroundResource(R.drawable.ease_input_bar_bg_normal);
    ...
    public void setSpeakBtnPress() {
        mSpeakTv.setText("松开结束");
    }

    public void setSpeakBtnRelease() {
...
//            edittext_layout.setBackgroundResource(R.drawable.ease_input_bar_bg_active);
    ...
    public void setMoreIconKeyBoard() {
        buttonMore.setBackground(getContext().getResources().getDrawable(R.mipmap.keyboard));
    }

    public void setMoreIconAdd() {
        buttonMore.setBackground(getContext().getResources().getDrawable(R.mipmap.add));
    }
